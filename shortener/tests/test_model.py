...
class TestShortenerModel(TestCase):
    def test_model_str(self):
        testShortener1 = Shortener.objects.create(long_url="https://docs.djangoproject.com/en/3.2/", short_url="testingOnly1")
        ...
        testShortener3 = Shortener.objects.create(long_url="https://docs.djangoproject.com/en/3.2/topics/db/models/", short_url="asdfgds", custom_short_url="testingOnly3")
