...
class TestShortenService(TestCase):
    def setUp(self):
        ...
        self.testShortenerNoCustomShortUrl = Shortener.objects.create(long_url="https://www.djangoproject.com/start/overview/", random_short_url="hgfdh", custom_short_url=None)
    ...
    def test_updateShortener(self):
        # update random_short_url
        self.assertTrue(self.testShortenerNoRandomShortUrl.random_short_url is None)
        updateShortener(self.testShortenerNoRandomShortUrl, shortUrl=self.newRandomShortUrl)
        self.assertFalse(self.testShortenerNoRandomShortUrl.random_short_url is None)
